...
from comcigan_api.services.school import findSchool
...
@app.get("/schools/{name}/{grade}/{cls}")
...
@app.get("/schools/{name}/{grade}/{cls}/{day}")
...
@app.get("/schools/{name}/{grade}/{cls}/{day}/{period}")
